...
export const semesterSettings = pgTable("semester_settings", {
  ...
  course1ClassTime2: text("course1_class_time2"),
  course1ClassEndTime2: text("course1_class_end_time2"),
  ...
  course1Color: text("course1_color"),
  course1ColorEnd: text("course1_color_end"),
  course1ColorStops: text("course1_color_stops"),
  course1BorderColor: text("course1_border_color"),
  course1CourseRowColor: text("course1_course_row_color"),
  course1TaskBgColor: text("course1_task_bg_color"),
  course1CourseFontColor: text("course1_course_font_color"),
  course1ModuleBoxColor: text("course1_module_box_color"),
  course1ReadingBoxColor: text("course1_reading_box_color"),
  course1ModuleFolder: text("course1_module_folder"),
  course1ReadingFolder: text("course1_reading_folder"),
  course1DisplayName: text("course1_display_name"),
  ...
  course2ClassTime2: text("course2_class_time2"),
  course2ClassEndTime2: text("course2_class_end_time2"),
  ...
  course2Color: text("course2_color"),
  course2ColorEnd: text("course2_color_end"),
  course2ColorStops: text("course2_color_stops"),
  course2BorderColor: text("course2_border_color"),
  course2CourseRowColor: text("course2_course_row_color"),
  course2TaskBgColor: text("course2_task_bg_color"),
  course2CourseFontColor: text("course2_course_font_color"),
  course2ModuleBoxColor: text("course2_module_box_color"),
  course2ReadingBoxColor: text("course2_reading_box_color"),
  course2ModuleFolder: text("course2_module_folder"),
  course2ReadingFolder: text("course2_reading_folder"),
  course2DisplayName: text("course2_display_name"),
  ...
  course3ClassTime2: text("course3_class_time2"),
  course3ClassEndTime2: text("course3_class_end_time2"),
  ...
  course3Color: text("course3_color"),
  course3ColorEnd: text("course3_color_end"),
  course3ColorStops: text("course3_color_stops"),
  course3BorderColor: text("course3_border_color"),
  course3CourseRowColor: text("course3_course_row_color"),
  course3TaskBgColor: text("course3_task_bg_color"),
  course3CourseFontColor: text("course3_course_font_color"),
  course3ModuleBoxColor: text("course3_module_box_color"),
  course3ReadingBoxColor: text("course3_reading_box_color"),
  course3ModuleFolder: text("course3_module_folder"),
  course3ReadingFolder: text("course3_reading_folder"),
  course3DisplayName: text("course3_display_name"),
...
export const tasks = pgTable("tasks", {
  ...
  gradeWeight: doublePrecision("grade_weight"), // Percentage of final grade (e.g., 25 = 25%, 0.4 = 0.4%)
  gradeValue: doublePrecision("grade_value"), // Score achieved (e.g., 4.45 out of 7.5)
  ...
  reminder1Methods: text("reminder_1_methods"),
  reminder2Methods: text("reminder_2_methods"),
  reminder3Methods: text("reminder_3_methods"),
  reminder4Methods: text("reminder_4_methods"),
  reminder4DateTime: text("reminder_4_date_time"),
  showCountdownBar: boolean("show_countdown_bar").default(true),
  showCountdownBarMain: boolean("show_countdown_bar_main").default(true),
...
export function getWeekNumber(date: Date, customSemesterStart?: Date, readingWeekStart?: Date | null): number {
  ...
  if (readingWeekStart) {
    ...
    if (weekNum >= rwWeek) {
      ...
      if (normalizedDate.getTime() >= rwStart.getTime() && normalizedDate.getTime() < rwEnd.getTime()) {
        return -1;
      }
      if (weekNum > rwWeek) {
        weekNum -= 1;
...
export function getWeekDates(weekNum: number, customSemesterStart?: Date, readingWeekStart?: Date | null): { start: Date; end: Date } {
  ...
  const weekStartMs = startOfSemester.getTime() + (calendarWeek - 1) * 7 * msPerDay;
...
export const profileSettings = pgTable("profile_settings", {
  ...
  showAddTask: boolean("show_add_task").default(true),
  showCompletedTasks: boolean("show_completed_tasks").default(true),
  showCourses: boolean("show_courses").default(true),
  showLibrary: boolean("show_library").default(false),
  showSpotify: boolean("show_spotify").default(true),
  showHomeAssistant: boolean("show_home_assistant").default(false),
  showAstronomy: boolean("show_astronomy").default(true),
