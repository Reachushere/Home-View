        ...
        >
          ...
          <div className="space-y-2">
            {AUTOMATION_CATEGORIES.map((category) => {
              ...
              const isYellowCat = category.id === 'data';
              const useCssGradient = isCalSync || isAutoTasks || isGreyCat || isRedCat || isYellowCat;
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start gap-2">
                              {isOneDrive
                                ? <img src={oneDriveBox} alt="OneDrive" className="h-4 w-4 flex-shrink-0 mt-0.5" style={{ filter: 'drop-shadow(0 1px 2px rgba(0,0,0,0.55))' }} />
