                  ...
                  {(() => {
                    ...
                    <div style={{ width: '200px' }}>
                      ...
                      <div className="relative" style={{ height: '16px', marginTop: '1px' }}>
                        ...
                        {midStops.length > 0 && <span className="text-white text-[9px] absolute" style={{ bottom: '-16px', left: '0px' }}>double-click bar to add · drag to move</span>}
                      </div>
                      {midStops.length === 0 && <div className="text-white text-[11px] text-left mt-1.5">double-click gradient bar to add a colour stop</div>}
            ...
            {courseTasks.length > 0 && (() => {
              ...
              return (
                <div className="flex items-end px-1.5 py-1 text-[8px] font-bold text-white" style={{ margin: '0 4px', letterSpacing: '0' }}>
                  ...
                  <div className={`flex-1 min-w-0 ${hdrCls('title')}`} style={{ marginLeft: '22px' }} onClick={() => toggleSort('title')} data-testid="sort-title">
