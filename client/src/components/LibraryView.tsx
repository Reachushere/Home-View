...
import shelfBgImage from '@assets/Bookshelf6_1776010763162.jpg';
      ...
      >
        {courseBooks.length === 0 ? (
          ...
          courseBooks.map(({ course, files: courseFiles }, courseIdx) => {
            ...
            return (
            <div key={course.code} style={{ marginBottom: courseIdx < courseBooks.length - 1 ? (isCollapsed ? '20px' : '55px') : '0', position: 'relative', top: courseIdx === 0 ? '43px' : courseIdx === 1 ? '-33px' : courseIdx === 2 ? '-84px' : `${-81 + courseIdx * 5}px` }}>
              <div style={{
                display: 'flex',
                alignItems: 'center',
                gap: '10px',
                ...
                userSelect: 'none',
                position: 'relative',
                top: courseIdx === 0 ? '203px' : courseIdx === 1 ? '318px' : courseIdx === 2 ? (minimizedReaders.size > 0 ? '293px' : '313px') : '155px',
                zIndex: 10,
                marginLeft: 'calc(30% + 206px)',
              }}
              onClick={() => {
              ...
              <div style={{ position: 'relative', maxWidth: '100%', overflow: 'visible' }}>
                <div style={{
                  ...
                  overflowY: 'visible',
                  maxWidth: '100%',
                  ...(courseIdx > 0 ? { transform: 'scale(1.5) scaleX(0.84)', transformOrigin: 'bottom left' } : {}),
                }}
