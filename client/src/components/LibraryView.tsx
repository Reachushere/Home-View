      ...
      >
        {courseBooks.length === 0 ? (
          ...
          courseBooks.map(({ course, files: courseFiles }, courseIdx) => {
            ...
            return (
            <div key={course.code} style={{ marginBottom: courseIdx < courseBooks.length - 1 ? (isCollapsed ? '20px' : '55px') : '0', position: 'relative', top: courseIdx === 0 ? '45px' : courseIdx === 1 ? '23px' : courseIdx === 2 ? '-68px' : `${-65 + courseIdx * 5}px` }}>
              <div style={{
                display: 'flex',
                alignItems: 'center',
                gap: '10px',
                ...
                userSelect: 'none',
                position: 'relative',
                top: courseIdx === 0 ? '225px' : courseIdx === 1 ? '340px' : courseIdx === 2 ? (minimizedReaders.size > 0 ? '300px' : '335px') : '165px',
                zIndex: 10,
                marginLeft: 'calc(30% + 213px)',
              }}
              onClick={() => {
