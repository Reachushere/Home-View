...
const ROOM_HOTSPOTS: { room: string; x: number; y: number; w: number; h: number; entityId: string; groupEntityId: string; deviceType: string; icon: string; nightImg?: string; labelOffsetX?: number; labelOffsetY?: number; volumeOffsetX?: number; volumeOffsetY?: number; hideLabel?: boolean }[] = [
  ...
  { room: "Pug Washroom", x: 2, y: 5, w: 16, h: 32, entityId: "media_player.echo_show_pug_am", groupEntityId: "media_player.pug_media_group", deviceType: "echo_show", icon: "bath", nightImg: pugNight, labelOffsetX: -35, labelOffsetY: 35, volumeOffsetX: 35, volumeOffsetY: 35 },
  { room: "Hallway", x: 19, y: 5, w: 16, h: 32, entityId: "media_player.hallway_2", groupEntityId: "media_player.hallway_media_group", deviceType: "echo", icon: "hallway", nightImg: hallwayNight, labelOffsetX: 80, labelOffsetY: -175, volumeOffsetX: 130, volumeOffsetY: -175 },
  { room: "Kitchen", x: 36, y: 5, w: 28, h: 45, entityId: "media_player.kitchen_lr", groupEntityId: "media_player.kitchen_media_group", deviceType: "echo", icon: "kitchen", nightImg: kitchenNight, labelOffsetX: -95, labelOffsetY: -225, volumeOffsetX: -35, volumeOffsetY: -225 },
  ...
  { room: "King Bedroom", x: 65, y: 30, w: 33, h: 50, entityId: "media_player.king_bedroom", groupEntityId: "media_player.king_bedroom_media_group", deviceType: "echo", icon: "crown", nightImg: kingNight, labelOffsetX: 70, labelOffsetY: -294, volumeOffsetX: 130, volumeOffsetY: -294 },
  { room: "Cat Washroom", x: 84, y: 3, w: 14, h: 26, entityId: "media_player.cat_speakers", groupEntityId: "media_player.cat_washroom_media_group", deviceType: "echo", icon: "bath", nightImg: catNight, labelOffsetX: -465, labelOffsetY: -110, volumeOffsetX: -395, volumeOffsetY: -110 },
        ...
        <div className="flex flex-col flex-shrink-0 relative" style={{ width: menuOpen ? 200 : 48, transition: "width 0.3s ease" }}>
          ...
          <div className="relative z-10 flex flex-col h-full py-2">
            ...
            <div className="mt-auto flex flex-col gap-0.5 px-1 pb-1">
              <button onClick={() => { try { window.top!.location.href = "http://172.24.0.2:8123/test-home"; } catch(e) { window.location.href = "http://172.24.0.2:8123/test-home"; } }}
