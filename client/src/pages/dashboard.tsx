  ...
  return (
    <div className="flex h-screen">
      ...
      <main className="flex-1 p-6 overflow-auto flex flex-col">
        {/* Title Row */}
        <h1 className="text-lg font-semibold text-foreground mb-2" style={{ fontFamily: "'Nunito', sans-serif" }}>Bryn's Task Management</h1>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-semibold text-foreground min-w-[320px] text-center" style={{ fontFamily: "'Nunito', sans-serif" }}>
