        ...
        <div className={`mt-auto rounded-md p-2 text-[9px] ${allCoursesChecked ? 'bg-gray-300 text-gray-500' : 'bg-white text-black'}`}>
          <div className="border-2 border-black">
            ...
            <div className="flex">
              <div className="w-5 border-r border-black flex flex-col">
                <div className="flex-1"></div>
                <div className={`h-[38px] flex items-center justify-center ${checkedCourses['OPEN1'] ? 'bg-gray-300' : ''}`}>
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="px-1 pt-2 pb-3 flex items-end">
                  <input 
                    type="text" 
              ...
              <div className="w-12 border-l border-black flex flex-col">
                <div className="flex-1"></div>
                <div className={`h-[38px] flex flex-col items-center justify-start pt-1 gap-1 ${checkedCourses['OPEN1'] ? 'bg-gray-300' : ''}`}>
                ...
                <div className={`h-[26px] flex flex-col items-center justify-center gap-1 ${checkedCourses['OPEN2'] ? 'bg-gray-300' : ''}`}>
