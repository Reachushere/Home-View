          ...
          <div className="border-2 border-black">
            ...
            <div className="flex border-b border-black">
              ...
              <div className="flex-1 flex flex-col">
                <div className={`h-11 flex border-b border-black ${checkedCourses['ELECTIVE1'] ? 'bg-gray-300 text-gray-500' : ''}`}>
              ...
              <div className="w-12 border-l border-black flex flex-col">
                <div className={`h-11 flex flex-col items-center justify-center gap-1.5 border-b border-black ${checkedCourses['ELECTIVE1'] ? 'bg-gray-300' : ''}`}>
                ...
                <div className={`h-11 flex flex-col items-center justify-center gap-1.5 border-b border-black ${checkedCourses['ELECTIVE2'] ? 'bg-gray-300' : ''}`}>
        ...
        <div className={`mt-2 rounded-md p-2 text-[9px] ${allCoursesChecked ? 'bg-gray-300 text-gray-500' : 'bg-white text-black'}`}>
          <div className="border-2 border-black">
            ...
            <div className="flex">
              ...
              <div className="w-12 border-l border-black flex flex-col">
                <div className="px-1 pt-0.5 text-[8px] invisible">X</div>
                <div className="px-1 pt-2 pb-5 flex flex-col items-center justify-center gap-0.5">
                  <select className="w-10 text-[8px] border border-gray-400 rounded-sm bg-white text-black">
                    {gradeOptions.map(g => <option key={g} value={g}>{g}</option>)}
                  </select>
                  <input type="text" className="w-10 text-[8px] px-0.5 border border-gray-400 rounded-sm bg-white text-center text-black" placeholder="%" />
                </div>
                <div className="px-1 pt-1 pb-1 flex flex-col items-center justify-center gap-0.5">
                  <select className="w-10 text-[8px] border border-gray-400 rounded-sm bg-white text-black">
                    {gradeOptions.map(g => <option key={g} value={g}>{g}</option>)}
                  </select>
                  <input type="text" className="w-10 text-[8px] px-0.5 border border-gray-400 rounded-sm bg-white text-center text-black" placeholder="%" />
          ...
          <div className="border-2 border-black">
            ...
            <div className="flex">
              <div className="w-5 border-r border-black flex flex-col">
                ...
                <div className="flex items-center justify-center py-1"><input type="checkbox" className="checkbox-black" /></div>
                <div className="flex items-center justify-center py-1"><input type="checkbox" className="checkbox-black" /></div>
                <div className="flex items-center justify-center py-1"><input type="checkbox" className="checkbox-black" /></div>
              </div>
              <div className="flex-1 flex flex-col">
                <div className="px-1 pt-0.5 text-[8px]">OPEN ELECTIVE: <span className="font-bold">THREE</span> one-term courses required - options are listed in PR Table I.</div>
                <div className="px-1 py-1"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 1..." /></div>
                <div className="px-1 py-1"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 2..." /></div>
                <div className="px-1 py-1"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 3..." /></div>
              </div>
              <div className="w-12 border-l border-black flex flex-col">
                <div className="py-0.5"></div>
