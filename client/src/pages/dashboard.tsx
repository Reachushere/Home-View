        ...
        <div className={`mt-auto rounded-md p-2 text-[9px] ${allCoursesChecked ? 'bg-gray-300 text-gray-500' : 'bg-white text-black'}`}>
          <div className="border-2 border-black">
            ...
            <div className="flex">
              ...
              <div className="w-12 border-l border-black flex flex-col">
                <div className="flex-1"></div>
                <div className={`h-[46px] flex flex-col items-center justify-start -mt-4 gap-0.5 ${checkedCourses['OPEN1'] ? 'bg-gray-300' : ''}`}>
                ...
                <div className={`h-[26px] flex flex-col items-center justify-start -mt-4 gap-0.5 ${checkedCourses['OPEN2'] ? 'bg-gray-300' : ''}`}>
