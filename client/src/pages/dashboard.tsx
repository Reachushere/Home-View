    ...
    <div className="flex h-screen">
      ...
      <main className="flex-1 p-6 overflow-auto flex flex-col">
        ...
        <div className="flex gap-4 mb-3 items-stretch h-[200px] flex-shrink-0">
          ...
          <section className="flex-1 bg-yellow-100/50 dark:bg-yellow-800/40 rounded-xl shadow-md pt-1.5 px-3 pb-3 border-[1.75px] border-blue-800 overflow-auto" data-testid="section-upcoming">
            <h4 className="text-sm font-semibold mb-2 flex items-center gap-2" style={{ fontFamily: "'Open Sans', sans-serif" }}>
