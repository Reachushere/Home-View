          ...
          <div className="border-2 border-black">
            ...
            <div className="flex flex-col">
              <div className="flex">
                ...
                <div className="flex-1 px-1 pt-0.5 text-[8px]">
                  OPEN ELECTIVE: <span className="font-bold">THREE</span> one-term courses required - options are listed in PR Table I.
                </div>
                <div className="w-12 border-l border-black"></div>
              </div>
              <div className="flex items-center">
                <div className="w-5 border-r border-black flex items-center justify-center py-1">
                  <input type="checkbox" className="checkbox-black" />
                </div>
                <div className="flex-1 px-1 py-1">
                  <input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 1..." />
                </div>
                <div className="w-12 border-l border-black flex flex-col items-center justify-center gap-0.5 py-1">
                  <select className="w-10 text-[8px] border border-gray-400 rounded-sm bg-white text-black">
                    {gradeOptions.map(g => <option key={g} value={g}>{g}</option>)}
                  </select>
                  <input type="text" className="w-10 text-[8px] px-0.5 border border-gray-400 rounded-sm bg-white text-center text-black" placeholder="%" />
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 px-1 py-1">
                  <input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 2..." />
                </div>
                <div className="w-12 border-l border-black flex flex-col items-center justify-center gap-0.5 py-1">
                  <select className="w-10 text-[8px] border border-gray-400 rounded-sm bg-white text-black">
                    {gradeOptions.map(g => <option key={g} value={g}>{g}</option>)}
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 px-1 py-1">
                  <input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 3..." />
                </div>
                <div className="w-12 border-l border-black flex flex-col items-center justify-center gap-0.5 py-1">
                  <select className="w-10 text-[8px] border border-gray-400 rounded-sm bg-white text-black">
                    {gradeOptions.map(g => <option key={g} value={g}>{g}</option>)}
