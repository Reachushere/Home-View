        ...
        <div className="mt-2 rounded-md p-2 text-[9px] bg-white text-black">
          <div className="border-2 border-black">
            ...
            <div className="flex border-b border-black">
              ...
              <div className="w-14 px-1 py-0.5 border-r border-black">Core Req</div>
              <div className="w-14 px-1 py-0.5 border-r border-black">PPA 301</div>
              <div className="flex-1 px-1 py-0.5">Course Title</div>
              <div className="w-12 border-l border-black flex flex-col items-center justify-center gap-1.5 py-0.5">
                <select className="w-10 text-[8px] border border-gray-400 rounded-sm bg-white text-black">
                  {gradeOptions.map(g => <option key={g} value={g}>{g}</option>)}
            ...
            <div className="flex border-b border-black">
              ...
              <div className="w-14 px-1 py-0.5 border-r border-black">Core Req</div>
              <div className="w-14 px-1 py-0.5 border-r border-black">PPA 302</div>
              <div className="flex-1 px-1 py-0.5">Course Title</div>
              <div className="w-12 border-l border-black flex flex-col items-center justify-center gap-1.5 py-0.5">
                <select className="w-10 text-[8px] border border-gray-400 rounded-sm bg-white text-black">
                  {gradeOptions.map(g => <option key={g} value={g}>{g}</option>)}
      ...
      <main className="flex-1 p-6 overflow-auto flex flex-col">
        ...
        <div className="flex items-center mb-2">
          ...
          <div className="flex-1 flex items-center justify-between gap-2 ml-2">
            <Button size="sm" className="h-6 w-[100px] text-[10px] bg-white hover:bg-gray-50 border-[1.75px] border-blue-800 font-semibold text-blue-800" onClick={() => setSelectedWeek(2)} data-testid="button-today">
              TODAY
            </Button>
            <Button 
              size="sm" 
              className="h-6 w-[100px] text-[10px] bg-white hover:bg-gray-50 border-[1.75px] border-blue-800 font-semibold text-blue-800" 
            ...
            <Button 
              size="sm"
              className="h-6 w-[100px] bg-[#5979CC] hover:bg-[#4a68b3] text-[#ffffff] text-[10px] border-[1.75px] border-blue-800" 
