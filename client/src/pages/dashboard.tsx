        ...
        <div className="mt-auto bg-white rounded-md p-2 text-black text-[9px]">
          <div className="border-2 border-black">
            ...
            <div className="border-b border-black">
              <div className="flex border-b border-black">
                <div className={`w-5 px-0.5 py-0.5 border-r border-black flex items-center justify-center ${checkedCourses['ELECTIVE1'] ? 'bg-gray-300' : ''}`}>
                  <input type="checkbox" className="h-3 w-3" checked={checkedCourses['ELECTIVE1'] || false} onChange={() => toggleCourse('ELECTIVE1')} />
                </div>
                <div className="w-14 px-1 py-0.5 border-r border-black text-[8px] font-semibold flex items-center">Core Elec</div>
                <div className={`w-14 px-1 py-0.5 border-r border-black ${checkedCourses['ELECTIVE1'] ? 'bg-gray-300 text-gray-500' : ''}`}>PPA 120</div>
                <div className={`flex-1 px-1 py-0.5 ${checkedCourses['ELECTIVE1'] ? 'bg-gray-300 text-gray-500' : ''}`}>Canadian Politics & Government **</div>
                <div className={`w-12 border-l border-black flex flex-col items-center justify-center gap-0.5 py-0.5 ${checkedCourses['ELECTIVE1'] ? 'bg-gray-300' : ''}`}>
              ...
              <div className="flex border-b border-black">
                <div className={`w-5 px-0.5 py-0.5 border-r border-black flex items-center justify-center ${checkedCourses['ELECTIVE2'] ? 'bg-gray-300' : ''}`}>
                  <input type="checkbox" className="h-3 w-3" checked={checkedCourses['ELECTIVE2'] || false} onChange={() => toggleCourse('ELECTIVE2')} />
                </div>
                <div className="w-14 px-1 py-0.5 border-r border-black text-[8px] font-semibold flex items-center">Core Elec</div>
                <div className={`w-14 px-1 py-0.5 border-r border-black ${checkedCourses['ELECTIVE2'] ? 'bg-gray-300 text-gray-500' : ''}`}>PPA 121</div>
                <div className={`flex-1 px-1 py-0.5 ${checkedCourses['ELECTIVE2'] ? 'bg-gray-300 text-gray-500' : ''}`}>Ontario Politics and Government</div>
                <div className={`w-12 border-l border-black flex flex-col items-center justify-center gap-0.5 py-0.5 ${checkedCourses['ELECTIVE2'] ? 'bg-gray-300' : ''}`}>
              ...
              <div className="flex border-b border-black text-gray-400">
                <div className="w-5 px-0.5 py-0.5 border-r border-black"></div>
                <div className="w-14 px-1 py-0.5 border-r border-black text-[8px]">or</div>
            ...
            <div>
              <div className="flex border-b border-black">
                <div className={`w-5 px-0.5 py-0.5 border-r border-black flex items-center justify-center ${checkedCourses['OPEN1'] ? 'bg-gray-300' : ''}`}>
                  <input type="checkbox" className="h-3 w-3" checked={checkedCourses['OPEN1'] || false} onChange={() => toggleCourse('OPEN1')} />
                </div>
                <div className="w-14 px-1 py-0.5 border-r border-black text-[8px] font-semibold flex items-center">Open Elec</div>
                ...
                <div className={`w-12 border-l border-black flex flex-col items-center justify-center gap-0.5 py-0.5 ${checkedCourses['OPEN1'] ? 'bg-gray-300' : ''}`}>
              ...
              <div className="flex">
                <div className={`w-5 px-0.5 py-0.5 border-r border-black flex items-center justify-center ${checkedCourses['OPEN2'] ? 'bg-gray-300' : ''}`}>
                ...
                <div className={`w-12 border-l border-black flex flex-col items-center justify-center gap-0.5 py-0.5 ${checkedCourses['OPEN2'] ? 'bg-gray-300' : ''}`}>
