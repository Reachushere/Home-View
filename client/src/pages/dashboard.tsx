        ...
        <div className={`mt-2 rounded-md p-2 text-[9px] ${allCoursesChecked ? 'bg-gray-300 text-gray-500' : 'bg-white text-black'}`}>
          <div className="border-2 border-black">
            ...
            <div className="flex">
              ...
              <div className="flex-1 flex flex-col">
                <div className="h-4 px-1 text-[8px] flex items-center">OPEN ELECTIVE: <span className="font-bold">TWO</span> one-term courses required - options are listed in PR Table I.</div>
                <div className="h-9 px-1 flex items-center"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 1..." /></div>
                <div className="h-9 px-1 flex items-center"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 2..." /></div>
              </div>
              <div className="w-12 border-l border-black flex flex-col">
                <div className="h-4"></div>
        ...
        <div className="mt-2 rounded-md p-2 text-[9px] bg-white text-black">
          <div className="border-2 border-black">
            ...
            <div className="flex">
              ...
              <div className="flex-1 flex flex-col">
                <div className="h-4 px-1 text-[8px] flex items-center">OPEN ELECTIVE: <span className="font-bold">THREE</span> one-term courses required - options are listed in PR Table I.</div>
                <div className="h-9 px-1 flex items-center"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 1..." /></div>
                <div className="h-9 px-1 flex items-center"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 2..." /></div>
                <div className="h-9 px-1 flex items-center"><input type="text" className="w-full text-[10px] px-1 py-0.5 border border-black rounded-sm bg-white" placeholder="Course 3..." /></div>
              </div>
              <div className="w-12 border-l border-black flex flex-col">
                <div className="h-4"></div>
                <div className="h-9 flex flex-col items-center justify-center gap-0.5">
