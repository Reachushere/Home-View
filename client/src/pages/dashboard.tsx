        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex flex-col">
            ...
            <Button
              ...
              size="sm"
              onClick={toggleMute}
              className={`h-6 w-8 p-0 mt-1 bg-slate-500/20 hover:bg-slate-500/30 border-[1.75px] border-slate-500/40 text-slate-600 ${isMuted ? "!bg-red-500 hover:!bg-red-600 !border-red-500 !text-white" : ""}`}
