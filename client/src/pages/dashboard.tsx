          ...
          <div className="border-2 border-black">
            ...
            <div className="flex">
              <div className="w-5 border-r border-black flex flex-col">
                ...
                <div className={`h-6 flex items-center justify-center border-b border-black ${checkedCourses['OPEN1'] ? 'bg-gray-300' : ''}`}>
                  <input type="checkbox" className="h-3 w-3" checked={checkedCourses['OPEN1'] || false} onChange={() => toggleCourse('OPEN1')} />
                </div>
                <div className={`h-6 flex items-center justify-center ${checkedCourses['OPEN2'] ? 'bg-gray-300' : ''}`}>
              ...
              <div className="w-12 border-l border-black flex flex-col">
                <div className="h-4"></div>
                <div className={`h-6 flex flex-col items-center justify-center gap-0.5 border-b border-black ${checkedCourses['OPEN1'] ? 'bg-gray-300' : ''}`}>
                ...
                <div className={`h-6 flex flex-col items-center justify-center gap-0.5 ${checkedCourses['OPEN2'] ? 'bg-gray-300' : ''}`}>
