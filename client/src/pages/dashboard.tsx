    ...
    <div className="flex h-screen">
      ...
      <main className="flex-1 p-6 overflow-auto flex flex-col">
        ...
        <div className="flex items-start justify-between mb-6">
          <h1 className="text-xl font-bold text-foreground" style={{ fontFamily: "'Open Sans', sans-serif" }}>Bryn's Task Management</h1>
  ...
  if (hasAttachments) {
    return (
      <div className="relative pt-9">
        ...
        <div className={`absolute top-0 left-0 right-0 h-8 flex items-center justify-center gap-1 rounded-lg px-2 border ${colors ? `${colors.bg} ${colors.border}` : "bg-muted/50 border-muted"}`}>
          <Button
            size="icon"
            variant="ghost"
            className="h-6 w-6"
