        ...
        <div className={`mt-2 rounded-md p-2 text-[9px] ${allCoursesChecked ? 'bg-gray-300 text-gray-500' : 'bg-white text-black'}`}>
          <div className="border-2 border-black">
            ...
            <div className="flex items-stretch">
              ...
              <div className="flex-1 flex flex-col">
                <div className="h-7 px-1 py-0.5 text-[8px] flex items-center border-b border-black whitespace-nowrap"><span className="font-bold">CORE ELECTIVE:</span> <span className="font-bold">ONE</span> course required from the following:</div>
